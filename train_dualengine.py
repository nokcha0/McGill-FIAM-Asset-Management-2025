...
IN_FILE  = "output/data/final_data_text.csv"
OUT_PRED = "output/predictions/dualengine.csv"
ACC_FILE = "/teamspace/uploads/acc_ratios.csv"

# candidate text features generated by nlp_engine.py
TEXT_COLS = [
...
# normalize features cross-sectionally within each month to [-1,1]
...
# expanding folds: train ≥ min years, validate on next year, test on following year
...
def main():
    ...
    # Step 1: Load dataset
    print("[1/5] Loading merged dataset")
    df = pd.read_csv(IN_FILE, parse_dates=["date","ret_eom"], low_memory=False)
    ...
    # Step 3: Scale features and define folds
